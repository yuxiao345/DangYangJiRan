...
Build FirstCC (钱伲) and install to the booted simulator.
...
```bash
xcrun simctl install booted /tmp/firstcc-build/Build/Products/Debug-iphonesimulator/钱伲.app && xcrun simctl launch booted com.firstcc.app
```
